...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.NEXTJS]: {
    ...
    name: "nextjs",
    label: "Next.js",
    shortDescription: "React framework that makes SSR actually work! ⚡🚀",
    color: "#000000",
  ...
  [SkillNames.REACT]: {
    ...
    name: "react",
    label: "React",
    shortDescription: "Making UIs that don't hate you! ⚛️💚",
    color: "#61dafb",
  ...
  [SkillNames.NODEJS]: {
    ...
    name: "nodejs",
    label: "Node.js",
    shortDescription: "JavaScript everywhere - even in your coffee! ☕🌐",
    color: "#339933",
  ...
  [SkillNames.POSTGRES]: {
    ...
    name: "postgres",
    label: "PostgreSQL",
    shortDescription: "The database that SQL dreams are made of! 🐘🗄️",
    color: "#336791",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg",
  },
  [SkillNames.MONGODB]: {
    ...
    name: "mongodb",
    label: "MongoDB",
    shortDescription: "NoSQL? More like No Problems! 🍃💚",
    color: "#47a248",
  ...
  [SkillNames.DOCKER]: {
    ...
    name: "docker",
    label: "Docker",
    shortDescription: "It works on my machine - now it works on everyone's! 🐳📦",
    color: "#2496ed",
  ...
  [SkillNames.AWS]: {
    ...
    name: "aws",
    label: "AWS",
    shortDescription: "The cloud is your oyster! ☁️🦪",
    color: "#ff9900",
  ...
  [SkillNames.TAILWIND]: {
    ...
    name: "tailwind",
    label: "Tailwind CSS",
    shortDescription: "Utility-first CSS that's actually useful! 🎨✨",
    color: "#06b6d4",
  ...
  [SkillNames.WORDPRESS]: {
    ...
    name: "wordpress",
    label: "WordPress",
    shortDescription: "Powering the web, one blog at a time! 📝🌐",
    color: "#21759b",
...
export const SPLINE_NAME_TO_SKILL: Record<string, SkillNames> = {
  ...
  "wordpress": SkillNames.WORDPRESS,
};
